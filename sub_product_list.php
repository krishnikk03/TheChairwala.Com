                                        ...
                                        <div class="row">
											...
											<div class="col-xl-3 col-md-4 col-sm-6">
                                                <article class="list-product">
                                                    <div class="img-block">
													<center>
													   <?php $product_name=$product_name[$i];
														$replace_name=str_replace(' ','-',$product_name);
														
														?>
													    
                                                        <a href="single_product?product=<?php echo base64_encode($sub_id[$i]);?>&p=<?php echo $replace_name;?>" class="thumbnail">
                                                    ...
                                                    <div class="add-to-link-btns">
                                                        <!--<a class='btn button_color txu' href="single_product?product=<?php echo base64_encode($sub_id[$i]);?>">View</a>-->
																  <?php 
																	  $quantity=1;
