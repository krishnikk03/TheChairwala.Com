...
if($row=mysqli_fetch_array($query))
{
	...
	$query1=mysqli_query($conn,"select * from register where email='$e' and password='$p' and user_status='1'");
		...
		else
		{
			...
			echo json_encode(array("result"=>3,"msg"=>"Your Account Is Suspended.Please Contact Customer Care."));
		}
...
{
	echo json_encode(array("result"=>4,"msg"=>"Please Enter Correct Email Or Password."));
}
